    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick = {() => setHomeScore(homeScore * 0)} className = "homeButtons_reset">Reset Score</button>
        </div>
        <div className="awayButtons">
          ...
          <button onClick = {() => setAwayScore(awayScore * 0)} className = "awayButtons_reset">Reset Score</button>
        </div>
      </section>
    </div>
  );
